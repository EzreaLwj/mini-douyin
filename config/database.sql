...
(
    ...
    work_count       int      default 0                 null comment '作品数',
    favorite_count   int      default 0                 null comment '喜欢数',
    total_favorited  varchar(64)                        null comment '获赞数量 ',
    signature        varchar(255)                       null comment '个人简介',
    background_image varchar(255)                       null comment '用户个人页顶部大图',
